<template>
  <section class="hero">
    <video class="hero__video" autoplay muted playsinline loop>
      <source src="https://cdn2.hubspot.net/hubfs/5540962/EcoCamp_2019/Video/EcoCamp%20Homepage%20Video%202%20L.mp4" type="video/mp4" >
    </video>
  ...
  <section id="quienessomos" class="container">
    ...
    <div class="phone-call cbh-phone cbh-green cbh-show  cbh-static" id="clbh_phone_div" style="">
      <a id="WhatsApp-button" href="https://wa.me/56966624704" target="_blank" class="phoneJs" title="WhatsApp 360imagem">
...
export default {
  ...
  methods: {
    enviarWhatsapp() {
  window.location.href = 'https://api.whatsapp.com/send?phone=' + 56966624704;
}
...
.hero__content{
  ...
  bottom: -55px; visibility:hidden;background-color:transparent;width:200px;height:200px;cursor:pointer;z-index:999; 
  ...
  .cbh-phone.cbh-show{visibility:visible}@-webkit-keyframes fadeInRight{0%{opacity:0;
    -webkit-transform:translate3d(100%,0,0);
    transform:translate3d(100%,0,0)}100%{opacity:1;
      -webkit-transform:none;transform:none}}@keyframes fadeInRight{0%{opacity:0;-webkit-transform:translate3d(100%,0,0);-ms-transform:translate3d(100%,0,0);transform:translate3d(100%,0,0)}100%{opacity:1;-webkit-transform:none;-ms-transform:none;transform:none}}
